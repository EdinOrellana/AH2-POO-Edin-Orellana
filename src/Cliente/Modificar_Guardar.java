...
if(VistaAdmin.BanderaGuardarActualizarCliente){
    controlador.guardar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflNIT.getText().trim() ,jtflCorreo.getText().trim(),jtflGenero.getText().trim());
}else{
    controlador.Actualizar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflNIT.getText().trim() ,jtflCorreo.getText().trim(),jtflGenero.getText().trim(), VistaAdmin.idcliente);
}
