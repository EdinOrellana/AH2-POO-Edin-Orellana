...
public class VistaLogin extends javax.swing.JInternalFrame {
    ...
    private void btnIniciarsesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarsesionActionPerformed
        int a = 0;
        if (("admin".equals(jtflContra.getText().trim())) && ("admin".equals(jtflContra.getText().trim()))) {
            Escritorio.remove(this);
            Escritorio.add(vistaAdmin);
            vistaAdmin.show();
            vistaAdmin.setVisible(true);
        } else if (!Modelo.datos.isEmpty()) {
            for (Modelo ap : Modelo.datos) {
                a += 1;
                if (((jtflContra.getText().trim()).equals(ap.getPassword())) && (jtflUsuario.getText().trim().equals(ap.getCodigo()))) {
                    Escritorio.remove(this);
                    Escritorio.add(Vistaven);
                    Vistaven.show();
                    Vistaven.setVisible(true);
                } else if (a == Modelo.datos.size()) {
