...
if(VistaAdmin.BanderaGuardarActualizarSucursal){
    controlador.guardar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflDireccion.getText().trim() ,jtflCorreo.getText().trim(),jtflTelefono.getText().trim());
}else{
    controlador.Actualizar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflDireccion.getText().trim() ,jtflCorreo.getText().trim(),jtflTelefono.getText().trim(), VistaAdmin.idsucursal);
}
