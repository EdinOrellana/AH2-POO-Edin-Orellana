...
if(VistaAdmin.BanderaGuardarActualizarProducto){
    controlador.guardar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflDescripcion.getText().trim() ,jtflCantidad.getText().trim(),jtflPrecio.getText().trim());
}else{
    controlador.Actualizar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflDescripcion.getText().trim() ,jtflCantidad.getText().trim(),jtflPrecio.getText().trim(), VistaAdmin.idproducto);
}
